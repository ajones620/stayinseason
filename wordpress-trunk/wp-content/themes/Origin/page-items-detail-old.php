<?php
/*
Template Name: Old Item Detail Page
*/
?>
<?php
...
<div id="main-content">
	...
	<div class='prep-wrapper'>
		...
		<div class='prep-detail-info-card' id='preparation'>

			<span class='prep-detail-info-card-title'>Preparation</span>

		</div>


		<div class='prep-detail-info-card' id='prep1'>

			<span class='prep-detail-info-card-title'>Grill</span>

			<p class='prep-detail-info-text' id='prep1text'>Peel, if desired, and cut into 1/2-inch slices. Brush slices on all sides generously with olive oil, melted butter, or cooking oil. Season as desired with herbs, salt, and ground black pepper. Place eggplant on a piece of heavy foil or directly on the grill rack.</p>
		...
		<div class='prep-detail-info-card' id='prep2'>

			<span class='prep-detail-info-card-title'>Sautee</span>

			<p class='prep-detail-info-text' id='prep2text'>Brush slices of eggplant with olive oil on all sides and sprinkle with salt and ground black pepper. Place about 1/3 cup seasoned fine dry bread crumbs in a shallow dish. Dip each slice of eggplant into the crumbs, coating thoroughly. Add the coated eggplant slices to the hot skillet and cook about 5 minutes per side or until golden.</p>

		</div>


		<div class='prep-detail-info-card' id='prep3'>

			<span class='prep-detail-info-card-title'>Roast</span>

			<p class='prep-detail-info-text' id='prep3text'>Preheat the oven to 450 degrees F. Line a 15x10x1-inch baking pan with foil or lightly grease it.Peel eggplant, if desired, and cut into 3/4-inch cubes. Place the cubes in a large bowl. For 6 cups eggplant (1 medium), in a small bowl combine three cloves garlic, minced; 1 tablespoon olive oil; 1/2 teaspoon salt; and 1/4 teaspoon ground black pepper. Toss eggplant with oil mixture and transfer to prepared pan. Roast eggplant about 20 minutes or until tender, stirring occasionally.</p>
